        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            <div class="flex items-start justify-between mb-4">
              <div>
                <h2 class="card-title text-2xl text-primary">Version 0.6.9</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <ul class="list-disc list-inside space-y-1 text-sm">
                  ...
                  <li>
                    <strong>Gaming Hub:</strong> Chess and arithmetic games with
                    leaderboards
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul class="list-disc list-inside space-y-1 text-sm">
                  ...
                  <li>
                    <strong>Search:</strong> Advanced fuzzy search with Fuse.js
                  </li>
                  <li>
